...
(
    ...
    client_contact_number bigint,
    photo_link character varying(256) COLLATE pg_catalog."default",
    datetime_create timestamp without time zone NOT NULL DEFAULT now(),
    datetime_modify timestamp without time zone NOT NULL DEFAULT now(),
